...
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/making-of-pic.png" width="400"/></center>
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/13-mdisk.png)
...
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/internet-code.png" width="150"/></center>
...
```
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/save-loop.gif"/></center>
...
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/internet-code-preproc.png" width="250"/></center>
...
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/table.jpg" alt=""/></center>
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/keypad.png)
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/saving-screen1.png)
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/saving-screen2.png)
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/saving-screen3.png)
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/tha-da.png)
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/jade.png)
...
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/blackbox.png" width="150"/></center>
...
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/dump.jpg" alt=""/></center>

Hey there beefy! Now it's the matter of setting a breakpoint on read access and waiting for the game to choke on it:

<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/breakpoint.jpg" alt=""/></center>
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/encoding.png)
...
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/swap1.png" width="300"/></center>

Obviously, after swapping our renewed **12th** and **6th** bytes will look like that:

<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/swap2.png" width="300"/></center>
...
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/flip1.png" width="320"/></center>

Result of such operation is:

<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/flip2.png" width="320"/></center>
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/keypad-en.png)
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/keypad-ru.png)

* And **Internet code itself!**
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/code-en.png" width="250"/></center>
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/code-ru.png" width="250"/></center>
...
<center><img src="{{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/validate.png" width="100"/></center>
...
![]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/mu.png)
...
# Footnotes
[^1]:[English manual]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/manual-en.pdf)
[^2]:[Russian manual]({{site.baseurl}}/assets/{{page.date | date: "%Y-%m-%d"}}-{{page.url}}/manual-ru.pdf)
